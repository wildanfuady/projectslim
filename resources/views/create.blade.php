            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::text('name', '', ['class'=>'form-control', 'placeholder' => 'Nama Anda']) }}
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::textarea('address', '', ['class'=>'form-control', 'placeholder' => 'Nama Anda']) }}</div>
                    <div class="form-group">
                        {{ Form::label('Nilai', 'Nilai') }}
                        <div class="row">
                            <div class="col-md-10">
                                {{ Form::number('nilai', '', ['class'=>'form-control', 'placeholder' => 'Nilai', 'id' => 'nilai']) }}
                            </div>
                            <div class="col-md-2">
